...
// Dummy appointment data for medical partner
const Appointments = [
  {
    id: 1,
    time: "9:00 AM",
...
function MAppointment() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold text-blue-700 mb-6 text-center">Organization Appointments</h1>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center shadow border border-blue-100 mr-3">
                  <span className="text-lg font-bold text-blue-600">{appt.patient[0]}</span>
                </div>
                {/* Details */}
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-gray-600 text-sm">{appt.patient}</span>
                  </div>
