...
const Login = () => {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 animate-fade-in">
      ...
      >
        <h2 className="m-0 font-extrabold text-2xl text-blue-700 text-center tracking-wide animate-fade-in-down">Welcome Back</h2>
        <p className="text-gray-500 text-center text-sm mb-2 animate-fade-in-down delay-100">Sign in to your DiagnoBot account</p>
        <input
          type="email"
