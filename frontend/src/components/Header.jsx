...
const userLinks = [
  ...
  { to: "/user/chat", label: "Chat with AI" },
...
// Medical Partner Links
const partnerLinks = [
  { to: "/medical/dashboard", label: "Dashboard" },
  { to: "/medical/appointments", label: "Appointments" },
  { to: "/medical/settings", label: "Settings" },
];
...
const Header = () => {
  ...
  let links = userLinks;
  let homeRoute = "/user/dashboard";
  if (userType === "doctor") {
    links = doctorLinks;
    homeRoute = "/doctor/dashboard";
  } else if (userType === "partner") {
    links = partnerLinks;
    homeRoute = "/medical/dashboard";
  }
  ...
  return (
    <header className="bg-white shadow sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <Link to={homeRoute} className="font-bold text-xl text-blue-700">
          DiagnoBot
        </Link>
        {/* Desktop Nav */}
